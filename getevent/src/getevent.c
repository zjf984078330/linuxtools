...
Copyright 2009-2020 zhihong Co.,Ltd 

FileName: getevent.c 

Description:input子系统tool

Author:wangningbin 

Date:2018/6/1 Create 

Modification History: <version> <time> <author> <desc> 
a) 1.0 2018/06/01 wangningbin create
******************************************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char *argv[])
{
    ...
    if( NULL == ufds )
    {
        fprintf(stderr, "calloc memory fail\n");
        return -1;
    }
    ufds[0].fd = inotify_init();
    if(ufds[0].fd < 0)
    {
         fprintf(stderr, "notify event fail\n");
         return -1;
    }
